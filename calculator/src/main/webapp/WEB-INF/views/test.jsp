  ...
  <body>
    <div class="container">
      <div class="calculator">
        <div class="calculator_display_for_advanced">0</div>
        <div class="calculator_buttons">
          <div class="clear_and_enter">
	...
	const operator = document.querySelector(".calculator_operator"); // calculator__operator 엘리먼트와, 그 자식 엘리먼트의 정보를 모두 담고 있음.
	const display = document.querySelector(".calculator_display_for_advanced"); // calculator__display 엘리먼트와, 그 자식 엘리먼트의 정보를 모두 담고 있음.
